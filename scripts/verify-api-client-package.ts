...
const packageName = "pirate-api-client-0.1.0.tgz";
...
async function main(): Promise<void> {
  ...
  try {
    ...
    if (packedPackage.name !== "@pirate/api-client" || packedPackage.version !== "0.1.0") {
      throw new Error("Packed package identity/version is not @pirate/api-client@0.1.0");
    }
