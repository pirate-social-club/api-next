...
export const POSTGRES_TEST_SENTINELS: readonly PostgresSentinel[] = [
  ...
  {
    name: "postgres rewards qualification",
    path:
  ...
  {
    name: "postgres HNS control observer persistence",
    path:
  ...
  {
    name: "postgres community handle sales",
    path:
  ...
  {
    name: "postgres Spaces handle claims",
    path:
    ...
    contents: "api-next-control-plane-postgres-spaces-handle-claims-suite-complete\n",
  },
  {
