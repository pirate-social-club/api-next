...
const drawingProjection = (value: NonNullable<PublicSongMegapotPoolProjection["drawing"]>) => ({
  ...
  gross_prize_pool_atomic: value.grossPrizePoolAtomic?.toString() ?? null,
  global_tickets_bought: value.globalTicketsBought?.toString() ?? null,
  prize_pool_observed_at: value.prizePoolObservedAt,
  prize_pool_basis: value.prizePoolBasis,
  global_tickets_basis: value.globalTicketsBasis,
