...
CREATE TABLE song_reward_offers (
  ...
  reward_policy_version_id TEXT NOT NULL,
  created_at TIMESTAMPTZ NOT NULL DEFAULT clock_timestamp(),
  activated_at TIMESTAMPTZ,
  terminal_at TIMESTAMPTZ,
  updated_at TIMESTAMPTZ NOT NULL DEFAULT clock_timestamp(),
  FOREIGN KEY (community_id, post_id) REFERENCES posts (community_id, post_id),
  FOREIGN KEY (community_id, reward_policy_version_id)
    REFERENCES policy_versions (community_id, policy_version_id),
...
CREATE UNIQUE INDEX megapot_pool_drawings_one_entry_open_uidx
  ON megapot_pool_drawings (pool_leg_id) WHERE status = 'entry_open';
