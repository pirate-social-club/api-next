      ...
      try {
        ...
        await admin.query(
          `INSERT INTO megapot_drawing_observations (
             ...
             ('observation-cutoff-future','megapot-base-sepolia-v2',84532,202,10000,
                clock_timestamp()+interval '30 minutes',25,13,false,
                100000000000000000,100000000000000000,202,$3,
                clock_timestamp()-interval '1 hour',3,clock_timestamp(),
        ...
        await admin.query(
          `INSERT INTO megapot_pool_drawings (
             ...
             ($1,202,'observation-cutoff-future','entry_open',1,
                clock_timestamp()+interval '25 minutes',10000,0,0,
                NULL,NULL,NULL,NULL,NULL,NULL,
                clock_timestamp()-interval '20 minutes',
                clock_timestamp()-interval '20 minutes'),
