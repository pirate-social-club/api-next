...
function authorityRow(status: "pending" | "satisfied") {
  return {
    ...
    attempt_provider_id: VERY_WEB_PROVIDER_ID,
    attempt_provider_binding_hash: humanBindingHash,
    attempt_configuration_kind: "dynamic",
    attempt_configuration_ref: VERY_WEB_CONFIGURATION_REFERENCE,
    attempt_configuration_version: VERY_WEB_CONFIGURATION_VERSION,
...
function intentRow(input: {
  ...
  return {
    ...
    verification_provider_id: VERY_WEB_PROVIDER_ID,
    provider_configuration_kind: "dynamic",
    provider_configuration_ref: VERY_WEB_CONFIGURATION_REFERENCE,
    provider_configuration_version: VERY_WEB_CONFIGURATION_VERSION,
    expires_at: expiresAt,
