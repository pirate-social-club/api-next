...
export function requirementFromValue(
  value: unknown,
...
export function nextActionFromRequirements(
  row: Row,
  input: Readonly<{
...
export function rowColumns(prefix = ""): string {
...
export function routeV1ProjectionColumns(intentAlias: string): string {
