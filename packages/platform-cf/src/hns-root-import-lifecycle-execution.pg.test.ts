...
suite("HNS lifecycle leased execution sequences", () => {
  ...
  test("2: safe commitment arrives, then readiness, then authorized activation", async () => {
  ...
  test("3: exhausted finality deadline enters recovery with authority retained", async () => {
  ...
  test("4: duplicate delivery and a stolen lease neither duplicate effects nor extend deadlines", async () => {
