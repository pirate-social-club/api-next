...
SUBMISSION=media-submission-567f0079-ea59-4770-9fec-4da62b4134bd
...
plan='song-video-plan:media-submission-567f0079-ea59-4770-9fec-4da62b4134bd'
source=r['source_ref']
...
bun qualification/branch-helpers.ts host-env render host.url input output \
  ...
  "SONG_VIDEO_RENDER_HOST_ID=phone-acceptance-567f0079" \
