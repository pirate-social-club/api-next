...
SUBMISSION=media-submission-344d0a9c-6baa-4dfc-80d6-ef9a64aaaf99
...
plan='song-video-plan:media-submission-344d0a9c-6baa-4dfc-80d6-ef9a64aaaf99'
source=r['source_ref']
...
bun qualification/branch-helpers.ts host-env render host.url input output \
  ...
  "SONG_VIDEO_RENDER_HOST_ID=phone-acceptance-344d0a9c" \
