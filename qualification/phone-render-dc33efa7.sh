...
SUBMISSION=media-submission-dc33efa7-3302-4768-b871-b0bb5008e7bf
...
plan='song-video-plan:media-submission-dc33efa7-3302-4768-b871-b0bb5008e7bf'
source=r['source_ref']
...
bun qualification/branch-helpers.ts host-env render host.url input output \
  ...
  "SONG_VIDEO_RENDER_HOST_ID=phone-acceptance-dc33efa7" \
