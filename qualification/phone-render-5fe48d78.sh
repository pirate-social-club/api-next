...
SUBMISSION=media-submission-5fe48d78-3e65-4278-b0cd-7cf79fd0e4c9
...
plan='song-video-plan:media-submission-5fe48d78-3e65-4278-b0cd-7cf79fd0e4c9'
source=r['source_ref']
...
bun qualification/branch-helpers.ts host-env render host.url input output \
  ...
  "SONG_VIDEO_RENDER_HOST_ID=phone-acceptance-5fe48d78" \
