...
SUBMISSION=media-submission-3bc6c30b-e807-49d3-af23-939529f710d3
...
if r['song_post_id']!='media-post-media-operation-5f474b7a-6b47-4e86-b585-e65cf2cc3e3b' or int(r['clip_start_samples'])!=0 or int(r['clip_duration_samples'])!=1440000:
    raise SystemExit('STOP: frozen song interval differs')
plan='song-video-plan:media-submission-3bc6c30b-e807-49d3-af23-939529f710d3'
source=r['source_ref']
...
print(plan,r['attempt_id'],source.removeprefix('media://'),r['dispatch_output_key'].removeprefix('media://'))
PY
)
...
bun qualification/branch-helpers.ts host-env render host.url input output \
  ...
  "SONG_VIDEO_RENDER_HOST_ID=phone-acceptance-3bc6c30b" \
