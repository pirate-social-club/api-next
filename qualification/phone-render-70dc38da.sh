...
SUBMISSION=media-submission-70dc38da-19c8-403c-947a-1c91a2a1f7e0
...
plan='song-video-plan:media-submission-70dc38da-19c8-403c-947a-1c91a2a1f7e0'
source=r['source_ref']
...
bun qualification/branch-helpers.ts host-env render host.url input output \
  ...
  "SONG_VIDEO_RENDER_HOST_ID=phone-acceptance-70dc38da" \
